...
const Insights = () => {
    return (
        <div className="seccionInsights">
            <h1 className="tituloInsights" id="Insights">Insights</h1>
            ...
            <span className="fuenteInsights">Fuente: Kantar</span>
            <hr />
            ...
            <span className="fuenteInsights">Fuente: Nielsen</span>
            <hr />
            ...
            <span className="fuenteInsights">Fuente: Our world in data</span>
            <hr />
            ...
            <p className="textoInsights">Comprar menos ropa nueva y reducir el entretenimiento fuera de casa, son alguna de las acciones que toman al respecto.</p>
            <img className="imgInsights" src={Images.imgInsights8} alt="" /><br />
            <h2 className="tituloImgInsights">Acciones de ahorro</h2>
